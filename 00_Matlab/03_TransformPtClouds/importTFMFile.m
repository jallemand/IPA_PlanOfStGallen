function tfm = importTFMFile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   A6 = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   A6 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   a6 = importfile('a6.tfm', 1, 11);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/04/03 14:18:26
...
Ry = roty(raw{7,4});
Rz = rotz(raw{8,4});
tfm_matrix(1:3, 1:3) = Rz * Ry * Rx;

tfm_matrix(4,4) = 1;

tfm_matrix(4,1) = raw{9,4};
tfm_matrix(4,2) = raw{10,4};
tfm_matrix(4,3) = raw{11,4};


tfm = affine3d(tfm_matrix);
