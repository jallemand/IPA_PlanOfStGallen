function saveLayerDifferences(inputPSB, scratchDir, inputTiff, outDir) {
	// Load in the existing large photoshop file
	var fileRef = new File(inputPSB);
	app.open(fileRef);

	// Save to a temporary psd
	var Path = scratchDir;
	var Name = "temp_test.psb"
	...
	for (var i = 0; i < numLayers; i++) {
		...
		if (layer.name != 'Layer 1') {
			...
			currentLayer.name = currentLayer.name.split(".")[0] + "outside_diff"
		}
	}
...
// Define inputs and temp locations
var baseDirectories = []

var inFolder = "D:/Scratch/Stitched_Photoshop/"
var inMosaic = "FullRes_Normal_White_Auto_NoGeometricCorrection"
var inputPSB = inFolder + inMosaic + ".psb"
var inputTiff = inFolder + inMosaic + ".tif"

var scratchDir = "C:/Scratch/Temp"
var outDir = "D:/Scratch/Temp"
saveLayerDifferences(inputPSB, scratchDir, inputTiff, outDir);
